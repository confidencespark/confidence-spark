 ...
 * - 'Get Started' initiates a session by generating/fetching a device ID.
...
const IntroScreen = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      SystemNavigationBar.navigationHide(); // ⬇️ hide only bottom bar
      return () => SystemNavigationBar.navigationShow(); // restore
    }, []),
  );
