...
2.  **API Layer (Xano)**: The backend handling all logic, user data, and content.
3.  **Services**:
    - **Brevo**: Handles transactional emails triggered by Xano.
...
- **API Base URL**: Configured in `src/store/api/confidenceApi.js`.
